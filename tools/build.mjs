...
const ORDER = ["01_head.html", "02_data.js", "03_core.js", "04_glsl.js", "05_render.js", "06_ui.js", "07_main.js", "08_tail.html"];
let out = "";
...
const js = ORDER.slice(1, 7).map(f => readFileSync(join(ROOT, "parts", f), "utf8")).join("\n");
